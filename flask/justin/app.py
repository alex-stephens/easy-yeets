...
class User:
    ...
    def at_send_one_rest(self, rest_id) :
    ...
    def at_display_favourites(self) :
        ...
        for key in favouritesList:
            try:
                r = restLookup[key]
                elements.append(generate_element(r['name'],r['image_url'][0], 'Rating', r['rating']))
            except Exception as e:
                print('Error on:'
                , e, r)
